...
library(ggplot2)
library(ggcorrplot)
testing <- read_csv("/Users/kathyfu/Downloads/all/HTestLastNoY.csv")
training <- read_csv("/Users/kathyfu/Downloads/all/HTrainLast.csv")
...
predval$affordabilitty <- ifelse(predval$pred.logit == 1, 'Unaffordable', "Affordable")
predval <- predval[, -2]
write.csv(predval, "LassoPred.csv", row.names = FALSE)
